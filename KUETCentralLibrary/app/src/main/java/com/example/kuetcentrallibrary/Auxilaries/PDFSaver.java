    ...
    public static void save(Context context, View content, Uri fileUri) {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            if(ExternalStorageVerify.isExternalStorageWritable()) {
                ...
                PdfDocument.PageInfo pageInfo = new PdfDocument.PageInfo.Builder(content.getWidth(), content.getHeight()+30, 1).create();
            ...
            Toast.makeText(context,"Sorry, Print as PDF is not supported on your device",Toast.LENGTH_LONG).show();
        }
    }
